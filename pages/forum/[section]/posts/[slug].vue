<template>
  <div class="mx-auto w-full max-w-[900px]">
    ...
    <UCard v-else>
      <div>
        <PostContent
        @show-text-editor="setupModal('post', 'comment', sendComment, post)"
        type="post"
        :title="post.title"
        :date="post.date"
        ...
        <div class="space-y-4">
          ...
          @show-text-editor="setupModal('post', 'reply', sendReply, comment, post.id)"
          @show-update-text-editor="setupModal('update', 'comment', updateComment, comment)"
          type="comment"
          :date="comment.date"
          ...
          :body="comment.body">
            <template v-if="comment.replies.length > 0" #replies>
              ...
              @show-update-text-editor="setupModal('update', 'reply', updateReply, reply, comment.id)"
              type="reply"
              :date="reply.date"
